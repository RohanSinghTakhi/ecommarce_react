...
function SignUp() {
  ...
  const navigate = useNavigate(); // Moved this line outside of handleSubmit
      ...
      <div className="box_signup m-8 flex justify-center">
        ...
        <div className="login_Form ml-36 mt-40">
          <form onSubmit={handleSubmit}>
            ...
            <button className="btn btn-primary w-100 h-12 mb-2 py-2 mt-6" type="submit">Sign up</button>
